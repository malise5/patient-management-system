...
//        patient.setDateOfBirth(LocalDate.parse(patientRequestDTO.getDateOfBirth(), formatter));
//        patient.setRegistrationDate(LocalDate.parse(patientRequestDTO.getRegistrationDate(),formatter));
